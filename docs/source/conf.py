...
# ml_pokemon_kedro_mlflow documentation build
...
from ml_pokemon_kedro_mlflow import __version__ as release

# -- Project information -----------------------------------------------------

project = "ml_pokemon_kedro_mlflow"
...
htmlhelp_basename = "ml_pokemon_kedro_mlflowdoc"
...
latex_documents = [
    (
        master_doc,
        "ml_pokemon_kedro_mlflow.tex",
        "ml_pokemon_kedro_mlflow Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ml_pokemon_kedro_mlflow",
        "Project ml_pokemon_kedro_mlflow codebase.",
        "Data-Science",
    )
]
